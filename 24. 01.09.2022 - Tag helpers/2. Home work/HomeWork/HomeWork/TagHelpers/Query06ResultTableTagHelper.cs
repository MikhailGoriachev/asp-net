...
// Класс Тег хелпер для вывода результата запроса 6 в табличном виде
public class Query06ResultTableTagHelper : TagHelper
{
    // элементы
    public List<Query06Result> Items { get; set; } = new();
