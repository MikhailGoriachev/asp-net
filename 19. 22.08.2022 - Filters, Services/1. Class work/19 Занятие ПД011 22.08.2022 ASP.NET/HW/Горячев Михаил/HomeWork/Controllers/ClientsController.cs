...
public class ClientsController : Controller
{
    ...
    public ClientsController(IHostEnvironment environment)
    {
    ...
    [HttpPost]
    public IActionResult AddClient(ClientBindingModel model)
    {
    ...
    [HttpPost]
    public IActionResult EditClient(ClientBindingModel model)
    {
        // если модель невалидна
        if (!ModelState.IsValid)
        {
    ...
    [HttpPost]
    public IActionResult EditClientPassword(ClientPasswordBindingModel model)
    {
        // если модель невалидна
        if (!ModelState.IsValid)
        {
