...
public class SalesAccountingController : Controller
{
    ...
    // товары
    public async Task<IActionResult> GoodsListAsync(int pageNumber) => View(
    ...
    public async Task<IActionResult> Sellers(int pageNumber) => View(
    ...
    // закупки
    public async Task<IActionResult> Purchases(int pageNumber) => View(
    ...
    // продажи
    public async Task<IActionResult> Sales(int pageNumber) => View(
    ...
    public async Task<IActionResult> OrderBySales(string sortField, int pageNumber, SortStateSales sortState)
    {
        ...
        if (pageNumber != 0)
        {
            ...
            ViewBag.DateSaleSort = sortState == SortStateSales.DateSellAsc
