...
public class LibraryController : Controller
{
    ...
    {
        ViewBag.IsAdd = true;
        // return View("BookForm", new BookBindingForm(new Book(), default!));
    ...
    {
        Books = Books!.Prepend(new Book(book.Author, book.Title, book.PubYear, book.Count, book.Price, book.FormFile?.FileName ?? "default-book.jpg"));
    ...
    public IActionResult EditBook(int id)
    {
        ...
        return book == null ? NotFound() : View("BookForm", new BookBindingForm(book.Id, book.Author, book.Title, book.PubYear, book.Count, book.Price, default));
    }
...
public record BookBindingForm(int Id, string Author, string Title, int PubYear, int Count, int Price, IFormFile? FormFile);
