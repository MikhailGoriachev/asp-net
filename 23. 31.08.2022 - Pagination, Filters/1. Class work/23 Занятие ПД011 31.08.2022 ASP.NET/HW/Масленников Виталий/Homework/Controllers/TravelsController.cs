...
namespace Homework.Controllers
{
    public class TravelsController : Controller
    {
        ...
        public TravelsController(TravelAgencyContext context)
        {
            _context = context;
        }
        ...
        {
            var travelAgencyContext = _context.Travels
        ...
        public async Task<IActionResult> Create([Bind("Id,ClientId,RouteId,StartDate,Duration")] Travel travel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClientId,RouteId,StartDate,Duration")] Travel travel)
        {
            if (id != travel.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TravelAgencyContext.Travels'  is null.");
            }
            var travel = await _context.Travels.FindAsync(id);
            if (travel != null)
            {
