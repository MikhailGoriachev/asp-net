...
public sealed class PeriodicalsContext : DbContext
{
    ...
    {
        // удаление базы данных при её отсутствии
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        Periodical[] periodicals = {
            ...
            new Periodical { Id = 13,Index = "85356264", Name = "People", TypeEdition = "журнал", Date = Utils.GetDate(DateTime.Now.AddDays(-80), DateTime.Now), Duration = Utils.GetInt(1, 5), Price = 2500 },
        };
