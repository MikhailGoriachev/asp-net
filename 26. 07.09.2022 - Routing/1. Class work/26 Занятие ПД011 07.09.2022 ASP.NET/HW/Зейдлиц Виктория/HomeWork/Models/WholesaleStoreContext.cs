...
public class WholesaleStoreContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Purchase>()
            ...
            new Purchase { Id = 7,  GoodId = 5,  UnitId = 1, Amount = 10, PricePurchase = 420, DatePurchase = GetDate() },
            ...
            new Purchase { Id = 14, GoodId = 2,  UnitId = 9, Amount = 10, PricePurchase = 502, DatePurchase = GetDate() },
            ...
            new Purchase { Id = 18, GoodId = 12, UnitId = 9, Amount = 8,  PricePurchase = 525, DatePurchase = GetDate() },
        ...
        modelBuilder.Entity<Sale>()
            ...
            new Sale { Id = 4, DateSale = GetDate(), SellerId = 1, PurchaseId = 9, AmountSale = 1, PriceSale = 572 },  //UnitId = 9 },
            ...
            new Sale { Id = 8, DateSale = GetDate(), SellerId = 6, PurchaseId = 9, AmountSale = 4, PriceSale = 572 },  //UnitId = 9 },
            ...
            new Sale { Id = 12, DateSale = GetDate(), SellerId = 6, PurchaseId = 18, AmountSale = 2, PriceSale = 564 }, //UnitId = 9 },
