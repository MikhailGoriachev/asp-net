...
namespace EntityFrameworkInAspNetCoreMvcIntro.Controllers
{
    public class Companies1Controller : Controller
    {
        ...
        public Companies1Controller(UsersContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Companies != null ? 
                          ...
                          Problem("Entity set 'UsersContext.Companies'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'UsersContext.Companies'  is null.");
            }
            var company = await _context.Companies.FindAsync(id);
            if (company != null)
            {
