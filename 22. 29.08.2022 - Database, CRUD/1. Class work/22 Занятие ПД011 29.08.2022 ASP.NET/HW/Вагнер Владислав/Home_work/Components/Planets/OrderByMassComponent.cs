...
public class OrderByMassComponent : ViewComponent
{
    private GeneralModelService _generalModelService;

    //ctor с внедрением зависимостей
    public OrderByMassComponent(GeneralModelService modelService)
    {
    ...
    public async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        deserializationModel.PlanetsList = deserializationModel.PlanetsList.OrderByDescending(p => p.GravityNumeric).ToList();
