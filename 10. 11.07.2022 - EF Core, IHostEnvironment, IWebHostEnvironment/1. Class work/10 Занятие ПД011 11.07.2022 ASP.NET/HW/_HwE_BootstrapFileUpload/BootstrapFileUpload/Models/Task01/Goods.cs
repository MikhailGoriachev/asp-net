namespace BootstrapFileUpload.Models.Task01
{
    ...
    public class Goods
    {
        ...
        public static Dictionary<string, string> Images { get; private set; } = new Dictionary<string, string>
        {
            ["холодильник"] = "freedge.jpg",
            ["микроволновая печь"] = "microwave_oven.jpg",
            ["блинница"] = "pan_cacker.jpg",
            ["пылесос-робот"] = "robot_vc.jpg",
            ["стиральная машина"] = "wash_machine.jpg",
        };
    } // class Goods
}
